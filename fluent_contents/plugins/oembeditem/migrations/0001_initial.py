    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "embed_url",
                    fluent_contents.plugins.oembeditem.fields.OEmbedUrlField(
                        help_text="Enter the URL of the online content to embed (e.g. a YouTube or Vimeo video, SlideShare presentation, etc..)",
                        verbose_name="URL to embed",
                    ),
                ),
                (
                    "embed_max_width",
                ...
                (
                    "provider_url",
                    models.URLField(null=True, editable=False, blank=True),
                ),
                (
                    "thumbnail_url",
                    models.URLField(null=True, editable=False, blank=True),
