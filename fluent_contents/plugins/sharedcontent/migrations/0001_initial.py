...
def make_site(apps, schema_editor):
    ...
    Site.objects.get_or_create(
        pk=settings.SITE_ID, defaults=dict(name="example", domain="example.com")
    )
...
class Migration(migrations.Migration):
    ...
    dependencies = [("sites", "0001_initial"), ("fluent_contents", "0001_initial")]
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "slug",
                    models.SlugField(
                        help_text="This unique name can be used refer to this content in in templates.",
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="This allows contents can be shared between multiple sites in this project.<br>\nMake sure that any URLs in the content work with all sites where the content is displayed.",
                        verbose_name="Share between all sites",
                    ),
                ),
                (
                    "parent_site",
                    models.ForeignKey(
                        default=fluent_contents.plugins.sharedcontent.utils.get_current_site_id,
                        editable=False,
                        to="sites.Site",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        verbose_name="Shared content",
                        to="sharedcontent.SharedContent",
                        on_delete=models.CASCADE,
                    ),
                ),
            ],
