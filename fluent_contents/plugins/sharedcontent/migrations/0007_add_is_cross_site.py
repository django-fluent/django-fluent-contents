...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SharedContent.is_cross_site'
        db.add_column(u'sharedcontent_sharedcontent', 'is_cross_site',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SharedContent.is_cross_site'
        db.delete_column(u'sharedcontent_sharedcontent', 'is_cross_site')
