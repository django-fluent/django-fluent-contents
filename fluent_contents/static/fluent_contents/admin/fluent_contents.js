...
var fluent_contents = {
  ...
  widgets: {
     ...
     */
    enable_wysiwyg: function(root, selector) {
      cp_widgets.enable_wysiwyg(root, selector);
    },
     ...
     * @param selector Optional CSS selector for the elements.
     */
    disable_wysiwyg: function(root, selector) {
      cp_widgets.disable_wysiwyg(root, selector);
    },
  },
};
