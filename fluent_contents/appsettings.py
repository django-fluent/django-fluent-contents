...
FLUENT_CONTENTS_CACHE_PLACEHOLDER_OUTPUT = getattr(
...
FLUENT_CONTENTS_DEFAULT_LANGUAGE_CODE = getattr(
    settings, "FLUENT_CONTENTS_DEFAULT_LANGUAGE_CODE", FLUENT_DEFAULT_LANGUAGE_CODE
)
