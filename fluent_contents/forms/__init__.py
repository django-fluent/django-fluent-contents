...
class ContentItemForm(forms.ModelForm):
    ...
    parent_item = forms.ModelChoiceField(widget=forms.Select(), required=False, queryset=ContentItem.objects.all())
